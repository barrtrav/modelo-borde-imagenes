...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 550, 972, 80))
        ...
        self.pushButton_Minus.setGeometry(QtCore.QRect(250, 15, 25, 25))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./UiForm/../../icons/blue-folder-horizontal-open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLoad_Image.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./UiForm/../../icons/cross-circle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_Image.setIcon(icon2)
        self.actionRemove_Image.setObjectName("actionRemove_Image")
        self.actionSave = QtWidgets.QAction(MainWindow)
        self.actionSave.setEnabled(False)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./UiForm/../../icons/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon3)
        self.actionSave.setObjectName("actionSave")
        self.actionSave_Group = QtWidgets.QAction(MainWindow)
        self.actionSave_Group.setEnabled(False)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("./UiForm/../../icons/disk--pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_Group.setIcon(icon4)
        self.actionSave_Group.setObjectName("actionSave_Group")
        self.actionExit = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("./UiForm/../../icons/if_logout_48698.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExit.setIcon(icon5)
        self.actionExit.setObjectName("actionExit")
        self.actionEdges = QtWidgets.QAction(MainWindow)
        self.actionEdges.setEnabled(False)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("./UiForm/../../icons/application-image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEdges.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("./UiForm/../../icons/icon-diagram.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("./UiForm/../../icons/scissors.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionThreshold.setIcon(icon8)
        self.actionThreshold.setObjectName("actionThreshold")
        self.actionHelp = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("./UiForm/../../icons/question.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHelp.setIcon(icon9)
        self.actionHelp.setObjectName("actionHelp")
        self.actionAbout_the_Authors = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("./UiForm/../../icons/if_hire-me_48687.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout_the_Authors.setIcon(icon10)
        self.actionAbout_the_Authors.setObjectName("actionAbout_the_Authors")
        self.actionAbout_the_App = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("./UiForm/../../icons/if_special-offer_48729.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout_the_App.setIcon(icon11)
        ...
        self.actionImagesTree = QtWidgets.QAction(MainWindow)
        self.actionImagesTree.setCheckable(True)
        self.actionImagesTree.setChecked(True)
        self.actionImagesTree.setObjectName("actionImagesTree")
        ...
        self.menuView.addAction(self.actionImagesTree)
